...
<div class="navbar" role="banner">
    ...
    <div class="btn-group">
     <button type="button" id="mymodalNewConvenio" class="btn btn-info dropdown-toggle" data-toggle="dropdown"  >
          <span data-toggle="tooltip" title="Nuevo" >Nuevo </span><i class="fa fa-file-o" aria-hidden="true"></i> <span class="caret"></span>
        </button>
        <ul class="dropdown-menu" role="menu">
             <li><a href="#" data-toggle="modal" data-target="#myModal" >Usuario <i class="fa fa-user-o" aria-hidden="true"></i></a></li>
              <li><a href="#" data-toggle="modal" class="modalServicios" data-target="#myModalservicios" >Servicio <i class="fa fa-lightbulb-o" aria-hidden="true"></i></a></li>
      </ul>
